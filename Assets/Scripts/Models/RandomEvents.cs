...
public class RandomEvents
{
    ...
    public RandomEvents()
    {
        ...
        Events = new Event[]
        {
            new Event("Coronavirus", "Time for social distancing", socialChange: -30, gradeChange: 2),
            ...
            new Event("Assignment Extension", "Prof gives the class an extension on an assignment", gradeChange: 1, socialChange: 5),
            new Event("Rough Midterm", "Midterm does not resemble at all the practise midterms", gradeChange: -1, healthChange: -5),
            ...
            new Event("Sick Midterm", "A pretty bad cold comes upon you during midterm season", healthChange: -20, gradeChange: -2, socialChange: -10),
            new Event("Death", "There is a sudden death in the family.", healthChange: -5, gradeChange: -2),
